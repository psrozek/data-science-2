...
1. [numpy1.ipynb](https://github.com/psrozek/data-science/blob/main/numpy1.ipynb)
  * basic arrays
  * np.zeros, np.ones, np.random.rand

2. [opencv1.ipynb](https://github.com/psrozek/data-science/blob/main/opencv1.ipynb)
